...
plural_clause = '${' __ param:qualified_name __ ':' __ 'plural' __ ':' variants:plural_variant+ '}' {
    ...
    return new Plural(param, variantmap);
}
...
plural_type = '=' int:integer_literal { return int; }
